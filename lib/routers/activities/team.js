...
var _getUrlByType = function (company, team, code) {
  ...
  return (
    'otask/v1/tasks/companies/' + company + '/teams/' + team + '/tasks' + _url
  );
};
 ...
 * @async
 */
exports.Team.prototype.getList = function (company, team, params, callback) {
 ...
 * @async
 */
exports.Team.prototype.getSpecificList = function (
  company,
  team,
  code,
  callback
 ...
 * @async
 */
exports.Team.prototype.addActivity = function (
  company,
  team,
  params,
  callback
 ...
 * @async
 */
exports.Team.prototype.updateActivity = function (
  company,
  team,
  code,
  params,
 ...
 * @async
 */
exports.Team.prototype.archiveActivity = function (
  company,
  team,
  code,
  callback
 ...
 * @async
 */
exports.Team.prototype.unarchiveActivity = function (
  company,
  team,
  code,
  callback
...
exports.Team.prototype.updateBatch = function (company, params, callback) {
  debug('running request');
  this.api.client.put(
    'otask/v1/tasks/companies/' + company + '/tasks/batch',
    params,
    callback
  );
};
